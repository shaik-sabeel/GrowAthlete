...
const ProfileEdit = () => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                ...
                setImagePreview(user.profilePicture && user.profilePicture.startsWith('/uploads') ? `http://localhost:5000${user.profilePicture}` : user.profilePicture || defaultAvatar);
            } catch (err) {
    ...
    const handleImageFileChange = (e) => {
        ...
        if (file) {
            ...
            setImagePreview(formData.profilePictureUrl && formData.profilePictureUrl.startsWith('/uploads') ? `http://localhost:5000${formData.profilePictureUrl}` : formData.profilePictureUrl || defaultAvatar); 
        }
    };
                    ...
                    <div className="form-section">
                        ...
                        <div className="flex flex-col items-center gap-4">
                            ...
                            {profileImageFile && (
                                <button 
                                    type="button" 
                                    onClick={() => { setProfileImageFile(null); setImagePreview(formData.profilePictureUrl && formData.profilePictureUrl.startsWith('/uploads') ? `http://localhost:5000${formData.profilePictureUrl}` : formData.profilePictureUrl || defaultAvatar); }}
